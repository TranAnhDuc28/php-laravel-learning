            ...
            <div class="col-md-8">
                <div class="card" style="border-color: #0d6efd;">
                    ...
                    <div class="card-body">
                        ...
                        <form id="projectsForm" method="POST" action="{{ route('projects.store') }}">
                            @csrf
                            <div class="mb-3">
                                <label for="project_name" class="form-label">Project Name</label>
                                <input class="form-control @error('project_name') is-invalid @enderror" id="project_name" name="project_name" required />
                            </div>
