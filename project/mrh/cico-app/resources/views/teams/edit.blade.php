            ...
            <div class="col-md-8">
                <div class="card" style="border-color: #0d6efd;">
                    ...
                    <div class="card-body">
                        ...
                        <form id="teamsForm" method="POST" action="{{ route('teams.update', $teams) }}">
                            @csrf
                            @method('PUT')

                            <div class="mb-3">
                                <label for="team_name" class="form-label">Team Name</label>
                                <input class="form-control @error('team_name') is-invalid @enderror" id="team_name" name="team_name" value="{{ old('team_name', $teams->team_name) }}" required />
                            </div>
