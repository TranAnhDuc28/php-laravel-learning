            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card" style="border-color: #0d6efd;">
                        <h4 class="card-header text-center">Update Skill-Item</h4>
                        <div class="card-body">
                            <form method="post" action="{{ route('skill-item.processUpdate', ['id' => $skill_item->id]) }}">
                                @csrf
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <select name="category" class="form-select">
                                            @foreach($skill_categories as $skill_category)
                                                <option value="{{ $skill_category->id }}" {{ $skill_item->category_id == $skill_category->id ? 'selected':'' }}>{{ $skill_category->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('category')
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input id="id-name" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ $skill_item->name }}" required>
                                        @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="number" min="-1000" max="1000" id="id-display_order" name="display_order" class="form-control @error('display_order') is-invalid @enderror"
                                               value="{{ $skill_item->display_order ?? 0 }}" required>
                                        @error('display_order')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <textarea id="id-description" name="description" maxlength="500" class="form-control @error('description') is-invalid @enderror" style="max-height: 200px;">{{ $skill_item->description }}</textarea>
                                        @error('description')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                        </span>
