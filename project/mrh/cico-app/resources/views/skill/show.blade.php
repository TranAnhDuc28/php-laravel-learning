            ...
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <div class="card" style="border-color: #0d6efd;">
                        <h4 class="card-header text-center">Your skill</h4>
                        <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="id-skill" class="table table-bordered w-100">
                                        ...
                                        <tr class="align-middle">
                                            <td class="text-nowrap column-freeze"><a href="{{ route('skill-user.edit') }}" class="link-primary">{{ $user->name }}</a></td>
                                            ...
                                            @endforeach
                                            <td class="text-center text-nowrap">{{ $user->skill_updated_at }}</td>
                                            <td class="text-center"><a href="{{ route('skill-user.edit') }}" class="btn btn-sm btn-warning me-2">Edit</a></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                                <div class="text-center mt-4">
                                    <a href="{{ route('skill-user.export', ['user'=>null]) }}" class="btn btn-primary">Export Excel</a>
                                </div>
                            @endif
                        </div>
                    </div>
