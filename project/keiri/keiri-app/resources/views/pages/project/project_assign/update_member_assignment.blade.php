                                ...
                                <table class="table table-bordered">
                                    <tr>
                                        <td colspan="2">
                                            <div class="d-flex justify-content-between m-0">
                                                <div class="m-0">
                                                    <div class="fs-16 fw-bold">{{ __('Member') }}</div>
                                                ...
                                                <td colspan="2">
                                                    <div class="row">
                                                        <div class="col-sm-12 col-md-12 col-lg-12 d-flex justify-content-between align-items-center">
                                                            <div>
                                                                #{{ $loop->iteration }} ({{ $projectAssignLog->project_exit_date ? __('Leaving') : __('Joining') }})
{{--                                                                <span class="badge-dot {{ $projectAssignLog->project_exit_date ? 'badge-dot-dark' : 'badge-dot-success' }}"></span>--}}
                                                        ...
                                                        <div class="col-sm-12 col-md-6 col-lg-3 mt-3">
                                                            <label for="id-working_days-{{ $projectAssignLog->id }}" class="form-label">{{ __('Working days') }}</label>
                                                            <input type="number" id="id-working_days-{{ $projectAssignLog->id }}"
                                                                   name="logs[{{ $projectAssignLog->id }}][working_days]"
                                                                   class="form-control @error('logs.' . $projectAssignLog->id . '.working_days') is-invalid @enderror"
                                                                   value="{{ old('logs.' . $projectAssignLog->id . '.working_days', $projectAssignLog->working_days) }}">
                                                            @error('logs.' . $projectAssignLog->id . '.working_days')
                                                            <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                            @enderror
