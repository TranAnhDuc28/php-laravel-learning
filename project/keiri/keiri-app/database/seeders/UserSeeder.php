...
//        $employee31->save();
        ...
        $manager->job_position = 'PS_PM';
        $manager->full_name = 'Member 1';
//        $manager->username = 'user1@test.com';
//        $manager->password = Hash::make('12345678');
        $manager->role = UserRole::MANAGER;
        $manager->job_position = 'PM';
        $manager->employee_costs = 500000.00;
        $manager->save();

        $member1 = new User();
        $member1->department_id = 1;
        $member1->job_position = 'PG';
        $member1->full_name = 'Member 2';
//        $member1->username = 'user2@test.com';
//        $member1->password = Hash::make('12345678');
        $member1->role = UserRole::USER;
        $member1->employee_costs = 250000.00;
        $member1->save();

        $member2 = new User();
        $member2->department_id = 1;
        $member2->job_position = 'PG';
        $member2->full_name = 'Member 3';
//        $member2->username = 'user3@test.com';
//        $member2->password = Hash::make('12345678');
        $member2->role = UserRole::USER;
        $member2->employee_costs = 250000.00;
        $member2->save();

        $member2 = new User();
        $member2->department_id = 1;
        $member2->job_position = 'PG';
        $member2->full_name = 'Member 4';
        $member2->email = 'user4@test.com';
        $member2->password = Hash::make('12345678');
        $member2->role = UserRole::USER;
        $member2->employee_costs = 250000.00;
        $member2->save();
