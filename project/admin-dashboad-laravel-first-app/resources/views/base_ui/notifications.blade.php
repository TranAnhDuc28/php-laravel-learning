                        ...
                        <div class="card-header align-items-center d-flex">
                            ...
                            <div class="flex-shrink-0">
                                <div class="form-check form-switch form-switch-right form-switch-md">
                                    {{-- Preview code. --}}
                                    <label for="bootstrap-toast-show-code" class="form-label text-muted">Show Code</label>
                                    <input class="form-check-input code-switcher" type="checkbox" id="bootstrap-toast-show-code">
                                </div>
                            </div>
                        </div><!-- end card header -->
                                        ...
                                        <div class="col-xxl-6">
                                            <div>
                                                <p class="text-muted">
                                                    ...
                                                    for notifications, as is the top middle. If you’re only ever going to show one toast
                            ...
                            <div class="d-none code-view">
                                <pre class="language-markup" style="height: 275px; white-space: pre">
                                    <code>
                                        ...
                                        &lt;div class=&quot;toast fade show&quot; role=&quot;alert&quot; aria-live=&quot;assertive&quot; data-bs-autohide=&quot;false&quot; aria-atomic=&quot;true&quot;&gt;
                                            &lt;div class=&quot;toast-header&quot;&gt;
                                                &lt;img src=&quot;build/images/bootstrap-logo.svg&quot; class=&quot;rounded me-2&quot; alt=&quot;...&quot; height=&quot;20&quot;&gt;
                                                &lt;span class=&quot;fw-semibold me-auto&quot;&gt;Bootstrap&lt;/span&gt;
                                                &lt;small&gt;06 mins ago&lt;/small&gt;
                                                &lt;button type=&quot;button&quot; class=&quot;btn-close&quot; data-bs-dismiss=&quot;toast&quot; aria-label=&quot;Close&quot;&gt;&lt;/button&gt;
                                            &lt;/div&gt;
                                        ...
                                        &lt;div class=&quot;bg-light&quot; aria-live=&quot;polite&quot; aria-atomic=&quot;true&quot; style=&quot;position: relative; min-height: 200px;&quot;&gt;
                                            &lt;div class=&quot;toast fade show&quot; role=&quot;alert&quot; aria-live=&quot;assertive&quot;
                                                aria-atomic=&quot;true&quot; data-bs-toggle=&quot;toast&quot; style=&quot;position: absolute; top: 16px; right: 16px;&quot;&gt;
                                                &lt;div class=&quot;toast-header&quot;&gt;
                                                    &lt;img src=&quot;build/images/bootstrap-logo.svg&quot; class=&quot;rounded me-2&quot; alt=&quot;...&quot; height=&quot;20&quot;&gt;
                                                    &lt;span class=&quot;fw-semibold me-auto&quot;&gt;Bootstrap&lt;/span&gt;
                                                    &lt;small&gt;06 mins ago&lt;/small&gt;
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            ...
                            <div class="flex-shrink-0">
                                <div class="form-check form-switch form-switch-right form-switch-md">
                                    <label for="toast-placement-show-code" class="form-label text-muted">Show Code</label>
                                    <input class="form-check-input code-switcher" type="checkbox" id="toast-placement-show-code">
                                </div>
                            </div>
                        </div><!-- end card header -->
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            ...
                            <div class="flex-shrink-0">
                                <div class="form-check form-switch form-switch-right form-switch-md">
                                    <label for="bordered-toast-show-code" class="form-label text-muted">Show Code</label>
                                    <input class="form-check-input code-switcher" type="checkbox" id="bordered-toast-show-code">
                                </div>
                            </div>
                        </div><!-- end card header -->
                            ...
                            <div class="live-preview">
                                <div class="position-relative">
                                    <div class="hstack flex-wrap gap-2">
                                        ...
                                        <button type="button" class="btn btn-warning" id="borderedToast3Btn">Warning Toast</button>
                                    ...
                                    <div style="z-index: 11">
                                        <div id="borderedToast3" class="toast toast-border-warning overflow-hidden mt-3" role="alert" aria-live="assertive" aria-atomic="true">
                                            <div class="toast-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            ...
                            <div class="flex-shrink-0">
                                <div class="form-check form-switch form-switch-right form-switch-md">
                                    <label for="toastify-show-code" class="form-label text-muted">Show Code</label>
                                    <input class="form-check-input code-switcher" type="checkbox" id="toastify-show-code">
                                </div>
                            </div>
                        </div><!-- end card header -->

                        <div class="card-body">
                            <h5 class="fs-14">Use Toastfy JS with HTML.</h5>
                            <p class="text-muted">
                                ...
                                <code>data-toast-close="close"</code> <code>data-toast-style="style"</code>
                                as per your toast requirement.
                            </p>
                            <div class="live-preview">
                                <div class="hstack flex-wrap gap-2">
                                    <button type="button" class="btn btn-light w-xs" data-toast data-toast-text="Welcome Back! This is a Toast Notification."
                                    ...
                                    <button type="button" class="btn btn-light w-xs" data-toast data-toast-text="Your application was successfully sent."
                                            data-toast-gravity="top" data-toast-position="center" data-toast-className="success" data-toast-duration="3000">
                                        Success
                                    </button>
                                    <button type="button" class="btn btn-light w-xs" data-toast data-toast-text="Warning! Something went wrong try again."
                                            data-toast-gravity="top" data-toast-position="center" data-toast-className="warning" data-toast-duration="3000">
                                        Warning
                                    </button>
                                    <button type="button" class="btn btn-light w-xs" data-toast data-toast-text="Error! An error occurred."
                                            data-toast-gravity="top" data-toast-position="center" data-toast-className="danger" data-toast-duration="3000">
                                        Error
                                    </button>
                                </div>
                                <div class="mt-4 pt-2">
                                    <p class="text-muted">Display position.</p>
                                    <div class="hstack flex-wrap gap-2">
                                        <button type="button" data-toast class="btn btn-light w-xs" data-toast-text="Welcome Back ! This is a Toast Notification"
                                                data-toast-gravity="top" data-toast-position="left" data-toast-duration="3000" data-toast-close="close">
                                            Top Left
                                        </button>
                                        <button type="button" class="btn btn-light w-xs" data-toast data-toast-text="Welcome Back ! This is a Toast Notification"
                                        ...
                                        <button type="button" data-toast class="btn btn-light w-xs" data-toast-text="Welcome Back ! This is a Toast Notification"
                                                data-toast-gravity="bottom" data-toast-position="left" data-toast-duration="3000" data-toast-close="close">
                                            Bottom Left
                                        </button>
                                        <button type="button" class="btn btn-light w-xs" data-toast data-toast-text="Welcome Back ! This is a Toast Notification"
                                                data-toast-gravity="bottom" data-toast-position="center" data-toast-duration="3000" data-toast-close="close">
                                            Bottom Center
                                        </button>
                                        <button type="button" data-toast class="btn btn-light w-xs" data-toast-text="Welcome Back ! This is a Toast Notification"
                                                data-toast-gravity="bottom" data-toast-position="right" data-toast-duration="3000" data-toast-close="close">
                                            Bottom Right
                                        </button>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-lg-4">
                                        <div class="mt-4">
                                            <p class="text-muted">Offset position.</p>
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                <button type="button" data-toast class="btn btn-light w-xs" data-toast-text="Welcome Back! This is a Toast Notification"
                                                        data-toast-gravity="top" data-toast-position="right" data-toast-duration="3000" data-toast-offset data-toast-close="close">
                                                    Click Me
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mt-4">
                                            <p class="text-muted">Close icon display.</p>
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                <button type="button" class="btn btn-light w-xs" data-toast data-toast-text="Welcome Back! This is a Toast Notification"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mt-4">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                <button type="button" class="btn btn-light w-xs" data-toast data-toast-text="Toast Duration 5s"
                            ...
                            <div class="mt-5">
                                <h5 class="fs-14">Use Toastfy JS with HTML.</h5>
                                <p class="text-muted">
                                    Use <code>Toastify({...}).showToast()</code>.
                                </p>
                                <div class="live-preview">
                                    <div class="hstack flex-wrap gap-2">
                                        <button type="button" id="btn-toastfy-js-default" class="btn btn-light w-xs">Default</button>
                                        <button type="button" id="btn-toastfy-js-success" class="btn btn-light w-xs">Success</button>
                                        <button type="button" id="btn-toastfy-js-warning" class="btn btn-light w-xs">Warning</button>
                                        <button type="button" id="btn-toastfy-js-error" class="btn btn-light w-xs">Error</button>
                                    </div>
                                    <div class="mt-4 pt-2">
                                        <p class="text-muted">Display position.</p>
                                        <div id="group-btn-toastfy-display-position" class="hstack flex-wrap gap-2">
                                            <button type="button" class="btn btn-light w-xs" data-gravity="top" data-position="left">Top Left</button>
                                            <button type="button" class="btn btn-light w-xs" data-gravity="top" data-position="center">Top Center</button>
                                            <button type="button" class="btn btn-light w-xs" data-gravity="top" data-position="right">Top Right</button>
                                            <button type="button" class="btn btn-light w-xs" data-gravity="bottom" data-position="left">Bottom Left</button>
                                            <button type="button" class="btn btn-light w-xs" data-gravity="bottom" data-position="center">Bottom Center</button>
                                            <button type="button" class="btn btn-light w-xs" data-gravity="bottom" data-position="right">Bottom Right</button>
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-lg-4">
                                            <div class="mt-4">
                                                <p class="text-muted">Offset position.</p>
                                                <div class="d-flex align-items-center flex-wrap gap-2">
                                                    <button type="button" id="btn-toastfy-offset-position" class="btn btn-light w-xs">Click Me</button>
                                                </div>
                                            </div>
                                        </div><!--end col-->
                                        <div class="col-lg-4">
                                            <div class="mt-4">
                                                <p class="text-muted">Close icon display.</p>
                                                <div class="d-flex align-items-center flex-wrap gap-2">
                                                    <button type="button" id="btn-toastfy-close-icon" class="btn btn-light w-xs">Click Me</button>
                                                </div>
                                            </div>
                                        </div><!--end col-->
                                        <div class="col-lg-4">
                                            <div class="mt-4">
                                                <p class="text-muted">Duration.</p>
                                                <div class="d-flex align-items-center flex-wrap gap-2">
                                                    <button type="button" id="btn-toastfy-duration" class="btn btn-light w-xs">Click Me</button>
                                                </div>
                                            </div>
                                        </div><!--end col-->
                                    </div><!--end row-->
                                ...
                                <div class="d-none code-view">
                                    <pre class="language-javascript mt-4" style="height: 340px;">
                                        <code>
                                            /* Toast */
