                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex flex-wrap gap-2 mb-3 mb-lg-0">
                                            ...
                                            <button type="button" class="btn btn-info btn-label rounded-pill"><i class="ri-airplay-line label-icon align-middle rounded-pill fs-16 me-2"></i> Info</button>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex flex-wrap gap-2">
                                            ...
                                            <button type="button" class="btn btn-danger btn-label right"><i class="ri-error-warning-line label-icon align-middle fs-16 ms-2"></i> Danger</button>
                                        </div>
                                    </div><!--end col-->
                                </div><!--end row-->
                            </div>
                            ...
                            <div class="d-none code-view">
                                <pre class="language-markup">
                                    <code>
                                        ...
                                        &lt;button type=&quot;button&quot; class=&quot;btn btn-info btn-label waves-effect waves-light rounded-pill&quot;&gt;&lt;i class=&quot;ri-airplay-line label-icon align-middle rounded-pill fs-16 me-2&quot;&gt;&lt;/i&gt; Info&lt;/button&gt;
                                        ...
                                        &lt;button type=&quot;button&quot; class=&quot;btn btn-danger btn-label waves-effect right waves-light&quot;&gt;&lt;i class=&quot;ri-error-warning-line label-icon align-middle fs-16 ms-2&quot;&gt;&lt;/i&gt; Danger&lt;/button&gt;
                                    </code>
                                </pre>
                            </div>
                        </div><!-- end card-body -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Example of simple bottom border buttons.</p>
                            <div class="live-preview">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="hstack flex-wrap gap-2 mb-3 mb-lg-0">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="d-flex flex-wrap align-items-center gap-2">
                                            <button type="button" class="btn btn-primary custom-toggle active" data-bs-toggle="button">
                                                ...
                                                <span class="icon-off">Inactive</span>
                                            </button>
                                            <button type="button" class="btn btn-secondary custom-toggle active" data-bs-toggle="button">
                                                ...
                                                <span class="icon-off"><i class="ri-check-fill align-bottom me-1"></i> Disconnect</span>
                                            </button>
                            ...
                            <div class="d-none code-view">
                                <pre class="language-markup" style="height: 405px;">
                                    <code>
                                        &lt;!-- Custom Toggle Buttons --&gt;
                                        &lt;button type=&quot;button&quot; class=&quot;btn btn-primary custom-toggle active&quot; data-bs-toggle=&quot;button&quot;&gt;
                                            &lt;span class=&quot;icon-on&quot;&gt;&lt;i class=&quot;ri-alarm-line align-bottom&quot;&gt;&lt;/i&gt; Active&lt;/span&gt;
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">
                                Bootstrap has a base <code>.btn</code> class that sets up basic styles such as padding and content alignment. By default, <code>.btn</code> controls have a transparent border and background color, and lack
                            ...
                            <div class="d-none code-view">
                                <pre class="language-markup">
                                    <code>&lt;button type=&quot;button&quot; class=&quot;btn&quot;&gt;Base class&lt;/button&gt;</code>
                                </pre>
                            </div>
                        </div><!-- end card-body -->
                    </div><!-- end card -->
                            ...
                            <div class="live-preview">
                                <div class="d-flex flex-wrap align-items-center gap-2">
                                    <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                                        <input type="checkbox" class="btn-check" id="btn-check1" checked="">
                                        <label class="btn btn-primary mb-0" for="btn-check1">Checkbox 1</label>

                                        <input type="checkbox" class="btn-check" id="btn-check2">
                                        <label class="btn btn-primary mb-0" for="btn-check2">Checkbox 2</label>

                                        <input type="checkbox" class="btn-check" id="btn-check3">
                                        <label class="btn btn-primary mb-0" for="btn-check3">Checkbox 3</label>
                                    </div>

                                    <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                        <input type="radio" class="btn-check" name="btn-radio" id="btn-radio1" checked="">
                                        <label class="btn btn-outline-secondary mb-0" for="btn-radio1">Radio 1</label>

                                        <input type="radio" class="btn-check" name="btn-radio" id="btn-radio2">
                                        <label class="btn btn-outline-secondary mb-0" for="btn-radio2">Radio 2</label>

                                        <input type="radio" class="btn-check" name="btn-radio" id="btn-radio3">
                                        <label class="btn btn-outline-secondary mb-0" for="btn-radio3">Radio 3</label>
                                    </div>
                                </div>
                            </div>
                            <div class="d-none code-view">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <div class="btn-group-vertical" role="group" aria-label="Vertical radio toggle button group">
                                            <input type="radio" class="btn-check" name="v-btn" id="v-btn-radio1" checked="">
                                            <label class="btn btn-outline-secondary" for="v-btn-radio1">Radio 1</label>
                                            <input type="radio" class="btn-check" name="v-btn" id="v-btn-radio2">
                                            <label class="btn btn-outline-secondary" for="v-btn-radio2">Radio 2</label>
                                            <input type="radio" class="btn-check" name="v-btn" id="v-btn-radio3">
                                            <label class="btn btn-outline-secondary" for="v-btn-radio3">Radio 3</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="live-preview">
                                <div class="d-flex gap-3">
                                    <a href="javascript:void(0)" class="d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2">Focus ring</a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">
                                In addition to <code>.focus-ring</code>, we have several <code>.focus-ring-*</code> utilities to modify the helper class defaults. Modify the color with any of our
                                <a href="{{ route('baseUi.colors') }}" style="text-decoration: underline">theme colors</a>. Note that the light and dark variants may not be visible on all background colors given current color mode support.
                            </p>
                            <div class="live-preview">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <p class="mb-lg-0"><a href="javascript:void(0)" class="d-inline-flex focus-ring focus-ring-danger py-1 px-2 text-decoration-none border rounded-2">Danger focus</a></p>
                                    </div><!--end col-->
                                    <div class="col-lg-6">
                                        ...
                                        <p class="mb-0"><a href="javascript:void(0)" class="d-inline-flex focus-ring focus-ring-dark py-1 px-2 text-decoration-none border rounded-2">Dark focus</a></p>
                                    </div><!--end col-->
                                </div><!-- end row -->
                            </div>
