    ...
    <div class="page-content">
        <div class="container-fluid">
            <x-breadcrumb
                :title="'Images'"
                :breadcrumbs="[
                   ['label' => 'Base UI', 'url' => route('baseUi.images')],
            ...
            <div class="row">
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">
                                Use <code>rounded</code> class and <code>rounded-circle</code> class to show an image with a round border and rounded shape respectively.
                            </p>
                            <div class="live-preview">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <img class="rounded" alt="200x200" width="200" src="{{ asset('build/images/small/img-4.jpg') }}" data-holder-rendered="true">
                                    </div>
                                    <div class="col-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted mb-4">
                                Use <code>avatar-xxs</code>, <code>avatar-xs</code>, <code>avatar-sm</code>, <code>avatar-md</code>, <code>avatar-lg</code>,
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row g-3">
                                            <div class="col-xxl-2 col-md-4 col-6">
                                                <div>
                                                    <img src="{{ asset('build/images/users/avatar-2.jpg') }}" alt="" class="rounded avatar-xxs">
                                                    <p class="mt-2 mb-lg-0"><code>avatar-xxs</code></p>
                                                </div>
                                            </div>
                                            <div class="col-xxl-2 col-md-4 col-6">
                                                <div>
                                                    <img src="{{ asset('build/images/users/avatar-10.jpg') }}" alt="" class="rounded avatar-xs">
                                            ...
                                            <div class="col-xxl-2 col-md-4 col-6">
                                                <div>
                                                    <img src="{{ asset('build/images/users/avatar-8.jpg') }}" alt="" class="rounded avatar-xl">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row g-3 mt-5">
                                            <div class="col-xxl-2 col-md-4 col-6">
                                                <div>
                                                    <img src="{{ asset('build/images/users/avatar-2.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                    <p class="mt-2 mb-lg-0"><code>avatar-xxs</code></p>
                                                </div>
                                            </div>
                                            <div class="col-xxl-2 col-md-4 col-6">
                                                <div>
                                                    <img src="{{ asset('build/images/users/avatar-10.jpg') }}" alt="" class="rounded-circle avatar-xs">
                                                    <p class="mt-2 mb-lg-0"><code>avatar-xs</code></p>
                                                </div>
                                            </div>
                                            <div class="col-xxl-2 col-md-4 col-6">
                                            ...
                                            <div class="col-xxl-2 col-md-4 col-6">
                                                <div>
                                                    <img src="{{ asset('build/images/users/avatar-8.jpg') }}" alt="" class="rounded-circle avatar-xl">
                                                    <p class="mt-2 mb-lg-0"><code>avatar-xl</code></p>
                                                </div>
                                            </div><!-- end col -->
                                        </div><!-- end row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">
                                Use <code>avatar-xxs, avatar-xs, avatar-sm, avatar-md, avatar-lg, avatar-xl</code> class to set different avatar content.
                            </p>
                            <div class="live-preview">
                                <div class="row g-3">
                                    <div class="col-xxl-2 col-md-4 col-6">
                                ...
                                <pre class="language-markup">
                                    <code>
                                        ...
                                        &lt;div class=&quot;avatar-xxs&quot;&gt;
                                            &lt;div class=&quot;avatar-title rounded bg-primary-subtle text-primary&quot;&gt;XXS&lt;/div&gt;
                                        &lt;/div&gt;
                                        ...
                                        &lt;div class=&quot;avatar-sm&quot;&gt;
                                            &lt;div class=&quot;avatar-title rounded bg-success-subtle text-success&quot;&gt;SM&lt;/div&gt;
                                        &lt;/div&gt;

                                        &lt;div class=&quot;avatar-md&quot;&gt;
                                            &lt;div class=&quot;avatar-title rounded bg-info-subtle text-info&quot;&gt;MD&lt;/div&gt;
                                        &lt;/div&gt;

                                        &lt;div class=&quot;avatar-lg&quot;&gt;
                                            &lt;div class=&quot;avatar-title rounded bg-warning-subtle text-warning&quot;&gt;LG&lt;/div&gt;
                                        &lt;/div&gt;

                                        &lt;div class=&quot;avatar-xl&quot;&gt;
                                            &lt;div class=&quot;avatar-title rounded bg-danger-subtle text-danger&quot;&gt;XL&lt;/div&gt;
                                        &lt;/div&gt;
                                    </code>
                                </pre>
                            </div>
                                        ...
                                        <div class="mt-lg-0 mt-3">
                                            ...
                                            <div class="avatar-group">
                                                <div class="avatar-group-item">
                                                    <img src="{{ asset('build/images/users/avatar-4.jpg') }}" alt="" class="rounded-circle avatar-sm">
                                                </div>
                                                <div class="avatar-group-item">
                                                    <img src="{{ asset('build/images/users/avatar-5.jpg') }}" alt="" class="rounded-circle avatar-sm">
                                                </div>
                                                <div class="avatar-group-item">
                                                    <div class="avatar-sm">
                                                        <div class="avatar-title rounded-circle bg-light text-primary">A</div>
                                                    </div>
                                                </div>
                                                <div class="avatar-group-item">
                                                    <img src="{{ asset('build/images/users/avatar-2.jpg') }}" alt="" class="rounded-circle avatar-sm">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mt-lg-0 mt-3">
                                            ...
                                            <div class="avatar-group">
                                                ...
                                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Christi">
                                                    <div class="avatar-sm">
                                                        <div class="avatar-title rounded-circle bg-light text-primary">C</div>
                                                    </div>
                                                </a>
            ...
            {{-- Figures. --}}
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="card-title-desc text-muted">
                                Use the included <code>figure, figure-img</code> and <code>figure-caption</code> classes to provide some
                                baseline styles for the HTML5 <code>&lt;figure&gt;</code> and <code>&lt;figcaption&gt;</code> elements.
                            </p>
                            <div class="live-preview">
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        <figure class="figure mb-0">
                                            <img src="{{ asset('build/images/small/img-4.jpg') }}" class="figure-img img-fluid rounded" alt="...">
                                            <figcaption class="figure-caption">A caption for the above image.</figcaption>
                                        </figure>
                                    </div>
                                    <div class="col-sm-6">
                                        <figure class="figure mb-0">
                                            <img src="{{ asset('build/images/small/img-5.jpg') }}" class="figure-img img-fluid rounded" alt="...">
                ...
                <div class="col-xl-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="card-title-desc text-muted">
                                Responsive Images with <code>img-fluid, max-width: 100%; and height: auto;</code> to the image so that it scales with the parent width.
                            </p>
                            <div class="live-preview">
                                <div>
