    ...
    <div class="page-content">
        <div class="container-fluid">
            <x-breadcrumb
                :title="'Cards'"
                :breadcrumbs="[
                   ['label' => 'Base UI', 'url' => route('baseUi.cards')],
                   ['label' => 'Cards', 'url' => null]
                ]"
            />
            ...
            <div class="row">
                <div class="col-12">
                    <div class="justify-content-between d-flex align-items-center mb-4">
                        <h5 class="mb-0 pb-1 text-decoration-underline">Simple card</h5>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-xl-3">
                            <div class="card">
                                <img class="card-img-top img-fluid" src="{{ asset('build/images/small/img-1.jpg') }}" alt="Card image cap">
                                <div class="card-body">
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card">
                                <img class="card-img-top img-fluid" src="{{ asset('build/images/small/img-2.jpg') }}" alt="Card image cap">
                                <div class="card-body">
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card">
                                <img class="card-img-top img-fluid" src="{{ asset('build/images/small/img-3.jpg') }}" alt="Card image cap">
                                <div class="card-body">
                                    <p class="card-text">
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card">
                                ...
                                <img class="img-fluid" src="{{ asset('build/images/small/img-4.jpg') }}" alt="Card image cap">
                                <div class="card-body">
                                    <p class="card-text">
                    ...
                    <div class="row row-cols-xxl-5 row-cols-lg-3 row-cols-1">
                            ...
                            <div class="card card-body">
                                <div class="d-flex mb-4 align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('build/images/users/avatar-1.jpg') }}" alt="" class="avatar-sm rounded-circle"/>
                                    </div>
                        ...
                        <div class="col">
                            <div class="card card-body">
                                <div class="d-flex mb-4 align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('build/images/users/avatar-4.jpg') }}" alt="" class="avatar-sm rounded-circle"/>
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                        ...
                        <div class="col">
                            <div class="card card-body">
                                <div class="d-flex mb-4 align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('build/images/users/avatar-3.jpg') }}" alt="" class="avatar-sm rounded-circle"/>
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                        ...
                        <div class="col">
                            <div class="card card-body">
                                <div class="d-flex mb-4 align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('build/images/users/avatar-6.jpg') }}" alt="" class="avatar-sm rounded-circle"/>
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-footer">
                                    <a href="javascript:void(0);" class="link-success float-end">
                                        Payment Now <i class="ri-arrow-right-s-line align-middle ms-1 lh-1"></i>
                                    </a>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-3">
                                <i class="ri-user-3-fill align-middle me-1 text-muted"></i> Natasha Carey
                            </h4>
                            <p class="text-muted">
                            ...
                            <p class="text-muted mb-0">This response is important for our ability to learn from mistakes, but it also gives rise to self-criticism.</p>
                        </div>
                        <div class="card-footer text-center">
                            <a href="javascript:void(0);" class="link-secondary">
                                View All Notification (2) <i class="ri-arrow-right-s-line align-middle ms-1 lh-1"></i>
                            </a>
                        </div>
                    </div>
                </div><!-- end col -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">
                                ...
                                create a <a href="javascript:void(0);" class="text-decoration-underline"><b>Fantastic Design</b></a> by using
                                complicated 3D elements. Flat design is your friend. Remember that. And the
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">
                                ...
                                basics, I came up with a list of 30 graphic design tips that you can start
                                implementing. Each design is a new, unique piece of art birthed into this world.
                            </p>
            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4 text-center">
                            <div class="mx-auto avatar-md mb-3">
                                <img src="{{ asset('build/images/users/avatar-8.jpg') }}" alt="" class="img-fluid rounded-circle">
                            </div>
                ...
                <div class="col-xl-4">
                    <div class="card">
                        ...
                        <div class="card-body p-4 text-center">
                            <div class="mx-auto avatar-md mb-3">
                                <img src="{{ asset('build/images/users/avatar-5.jpg') }}" alt="" class="img-fluid rounded-circle">
                            </div>
                ...
                <div class="col-xl-4">
                    <div class="card">
                        ...
                        <div class="card-body p-4 text-center">
                            <div class="mx-auto avatar-md mb-3">
                                <img src="{{ asset('build/images/users/avatar-3.jpg') }}" alt="" class="img-fluid rounded-circle">
                            </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-shrink-0">
                                    <ul class="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                                        ...
                                        <li class="list-inline-item">
                                            <a class="align-middle minimize-card" data-bs-toggle="collapse" href="#collapseExample1" role="button" aria-expanded="false" aria-controls="collapseExample1">
                                                <i class="mdi mdi-plus align-middle plus"></i>
                                                <i class="mdi mdi-minus align-middle minus"></i>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <button type="button" id="close-card-none1" class="btn-close fs-10 align-middle"></button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-shrink-0">
                                    <ul class="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                                        ...
                                        <li class="list-inline-item">
                                            <button type="button" id="close-card-none2" class="btn-close fs-10 align-middle"></button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-shrink-0">
                                    <ul class="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                                        ...
                                        <li class="list-inline-item">
                                            <button type="button" id="close-card-none3" class="btn-close fs-10 align-middle"></button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-xxl-4 col-lg-6">
                            <div class="card card-overlay">
                                <img class="card-img img-fluid" src="{{ asset('build/images/small/img-12.jpg') }}" alt="Card image" loading="lazy">
                        ...
                        <div class="col-xxl-4 col-lg-6">
                            <div class="card card-overlay">
                                <img class="card-img img-fluid" src="{{ asset('build/images/small/img-1.jpg') }}" alt="Card image" loading="lazy">
                        ...
                        <div class="col-xxl-4 col-lg-6">
                            <div class="card card-overlay">
                                <img class="card-img img-fluid" src="{{ asset('build/images/small/img-5.jpg') }}" alt="Card image" loading="lazy">
                    ...
                    <div class="row">
                        <div class="col-xxl-4 col-lg-6">
                            <div class="card">
                                <img class="card-img-top img-fluid" src="{{ asset('build/images/small/img-6.jpg') }}" alt="Card image cap" loading="lazy">
                                <div class="card-body">
                                    ...
                                    <p class="card-text text-muted">
                                        ...
                                        farm-to-table craft beer twee. commodo enim craft beer mlkshk aliquot jean shorts ullamco.</p>
                        ...
                        <div class="col-xxl-4 col-lg-6">
                            <div class="card">
                                ...
                                <img class="card-img-bottom img-fluid" src="{{ asset('build/images/small/img-7.jpg') }}" alt="Card image cap" loading="lazy">
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-xxl-4 col-lg-6">
                            <div class="card">
                                ...
                                <img class="card-img rounded-0 img-fluid" src="{{ asset('build/images/small/img-8.jpg') }}" alt="Card image cap" loading="lazy">
                                <div class="card-footer">
                        ...
                        <div class="col-xxl-4 col-lg-6">
                            <div class="card">
                                ...
                                <img class="card-img rounded-0 img-fluid" src="{{ asset('build/images/small/img-10.jpg') }}" alt="Card image cap" loading="lazy">
                                <div class="card-footer">
                                    <p class="card-text mb-0">Last updated 3 mins ago</p>
                                </div>
                            </div>
                        ...
                        <div class="col-xxl-4 col-lg-6">
                            <div class="card">
                                <img class="card-img-top img-fluid" src="{{ asset('build/images/small/img-11.jpg') }}" alt="Card image cap" loading="lazy">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">A day in the of a professional fashion designer</h4>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-xxl-4 col-lg-6">
                            <div class="card">
                                ...
                                <img class="card-img-bottom img-fluid" src="{{ asset('build/images/small/img-11.jpg') }}" alt="Card image cap" loading="lazy">
                            </div>
                        </div><!-- end col -->
                    </div>
                </div><!-- end col -->
                    ...
                    <div class="row">
                        <div class="col-xxl-6">
                            <div class="card">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        <img class="rounded-start img-fluid h-100 object-fit-cover" src="{{ asset('build/images/small/img-12.jpg') }}" alt="Card image" loading="lazy">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-header">
                        ...
                        <div class="col-xxl-6">
                            <div class="card">
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-4">
                                        <img class="rounded-end img-fluid h-100 object-fit-cover" src="{{ asset('build/images/small/img-4.jpg') }}" alt="Card image" loading="lazy">
                                    </div>
                                </div>
                            </div><!-- end card -->
                        </div><!-- end col -->
                        <div class="col-xxl-6">
                            <div class="card">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        <img class="rounded-start img-fluid h-100 object-fit-cover" src="{{ asset('build/images/small/img-9.jpg') }}" alt="Card image" loading="lazy">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
                        ...
                        <div class="col-xxl-6">
                            <div class="card">
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-4">
                                        <img class="rounded-end img-fluid h-100 object-fit-cover" src="{{ asset('build/images/small/img-2.jpg') }}" alt="Card image" loading="lazy">
                                    </div>
                                </div>
                            </div><!-- end card -->
                        </div><!-- end col -->
                        ...
                        <div class="col-xxl-4">
                            <div class="card card-primary">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{ asset('build/images/users/avatar-1.jpg') }}" alt="" class="avatar-sm rounded-circle" loading="lazy">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <p class="card-text">
                                                <span class="fw-medium">JeffreyMontgomery</span> (Graphic Designer) started a new conversation.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="text-center">
                                        <a href="javascript:void(0);" class="link-light">
                                            Connect Now <i class="ri-arrow-right-s-line align-middle lh-1"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xxl-4">
                            <div class="card card-success">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{ asset('build/images/users/avatar-2.jpg') }}" alt="" class="avatar-sm rounded-circle">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <p class="card-text">
                                                <span class="fw-medium">Charles Dickens</span>(Financial Analyst) started a new conversation.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card card-info">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <p class="card-text">
                                                <span class="fw-medium">Oliver Phillips</span>(UI/UX Designer) started a new conversation.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card card-warning">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <p class="card-text">
                                        <span class="fw-medium">Rebecca Swartz</span> (Graphic Designer) started a new conversation.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card card-danger">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <p class="card-text">
                                        <span class="fw-medium">Betty Richards</span> (Back End Developer) started a new conversation.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card card-dark">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <p class="card-text">
                                        <span class="fw-medium">Brooke Hayes</span> (Founder & CEO) started a new conversation.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xxl-4">
                    <div class="card card-secondary">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('build/images/users/avatar-7.jpg') }}" alt="" class="avatar-sm rounded-circle">
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <p class="card-text">
                                        <span class="fw-medium">Bethany Johnson</span> (Team Leader) started a new conversation.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xxl-4">
                    <div class="card card-light">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('build/images/users/avatar-8.jpg') }}" alt="" class="avatar-sm rounded-circle">
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <p class="card-text">
                                        <span class="fw-medium">Amelie Townsend</span> (UI/UX Designer) started a new conversation.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xxl-4">
                            <div class="card border card-border-primary">
                                <div class="card-header">
                                    ...
                                    <h6 class="card-title mb-0">
                                        Handle to Forcast <span class="badge bg-danger align-middle fs-10">Poor</span>
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <p class="card-text">
                                        Whether article spirits new her covered hastily sitting her.
                                        Money witty books nor son add build on the card Chicken age had evening believe but proceed pretend mrs.
                                    </p>
                                    <div class="text-end">
                        ...
                        <div class="col-xxl-4">
                            <div class="card border card-border-success">
                                <div class="card-header">
                                    ...
                                    <h6 class="card-title mb-0">
                                        Quality Forcast <span class="badge bg-success align-middle fs-10">Excellent</span>
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <p class="card-text">
                        ...
                        <div class="col-xxl-4">
                            <div class="card border card-border-info">
                                <div class="card-header">
                                    <h6 class="card-title mb-0">
                                        Check your E-mails <span class="badge bg-info align-middle fs-10">In Process</span>
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <p class="card-text">
            ...
            <div class="row">
                <div class="col-xxl-4">
                    <div class="card border card-border-warning">
                        <div class="card-header">
                            <h6 class="card-title mb-0">
                                Check your Payment <span class="badge bg-warning align-middle fs-10">Pending</span>
                            </h6>
                        </div>
                        <div class="card-body">
                            <p class="card-text">
                ...
                <div class="col-xxl-4">
                    <div class="card border card-border-danger">
                        <div class="card-header">
                            <h6 class="card-title mb-0">
                                Your Ordered Cancel <span class="badge bg-danger align-middle fs-10">Cancel</span>
                            </h6>
                        </div>
                        <div class="card-body">
                            <p class="card-text">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card-group">
                        <div class="card mb-4">
                            <img class="card-img-top img-fluid" src="{{ asset('build/images/small/img-4.jpg') }}" alt="Card image cap"/>
                            <div class="card-body">
                        ...
                        <div class="card mb-4">
                            <img class="card-img-top img-fluid" src="{{ asset('build/images/small/img-5.jpg') }}" alt="Card image cap"/>
                            <div class="card-body">
                        ...
                        <div class="card mb-4">
                            <img class="card-img-top img-fluid" src="{{ asset('build/images/small/img-6.jpg') }}" alt="Card image cap"/>
                            <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-xxl col-6">
                    <div class="card h-100">
                        ...
                        <img class="img-fluid" src="{{ asset('build/images/small/img-11.jpg') }}" alt="Card image cap"/>
                        <div class="card-body">
                            <p class="card-text">
                ...
                <div class="col-xxl col-6">
                    <div class="card h-100">
                        <img class="card-img-top img-fluid" src="{{ asset('build/images/small/img-10.jpg') }}" alt="Card image cap"/>
                        <div class="card-body">
                            <h4 class="card-title">Give your text a good structure?</h4>
                            <p class="card-text">
                                This is a wider card with supporting text below as a natural lead-in to additional content.
                ...
                <div class="col-xxl col-6">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                Exercitation +1 labore velit, blog sartorial PBR leggings next level wes anderson artisan four loko farm-to-table craft beer twee.
                                ommodo enim craft beer mlkshk aliquip jean shorts ullamco.
                            </p>
                        </div>
                        <div class="card-footer">
                            <p class="card-text">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div id="group-card-masonry" class="row">
                        <div class="col-sm-6 col-lg-4">
                            <div class="card">
                                <img src="{{ asset('build/images/small/img-3.jpg') }}" class="card-img-top" alt="..."/>
                                <div class="card-body">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-2">A day in the of a professional fashion designer</h4>
                                    <p class="card-text text-muted">
                                        Exercitation +1 labore velit, blog sartorial PBR leggings next level wes anderson artisan four look farm-to-table craft beer twee.
                                    </p>
                                </div>
                                <img class="card-img rounded-0 img-fluid" src="{{ asset('build/images/small/img-8.jpg') }}" alt="Card image cap"/>
                                <div class="card-footer">
                                    <p class="card-text mb-0">Last updated 3 mins ago</p>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="card">
                                <img src="{{ asset('build/images/small/img-7.jpg') }}" class="card-img" alt="..."/>
                            </div>
                        </div><!-- end col -->
                        <div class="col-sm-6 col-lg-4">
                            <div class="card p-3">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex position-relative">
                                        <img src="{{ asset('build/images/users/avatar-3.jpg') }}" class="flex-shrink-0 me-3 avatar-xl rounded" alt="..."/>
                                        <div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row g-0 bg-light position-relative">
                                        <div class="col-md-5">
                                            <img src="{{ asset('build/images/small/img-4.jpg') }}" class="rounded-start img-fluid" alt="..."/>
                                        </div>
