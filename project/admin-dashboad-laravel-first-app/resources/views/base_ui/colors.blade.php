    ...
    <div class="page-content">
        <div class="container-fluid">
            <x-breadcrumb
                :title="'Colors'"
                :breadcrumbs="[
                   ['label' => 'Base UI', 'url' => route('baseUi.colors')],
                   ['label' => 'Colors', 'url' => null]
                ]"
            />
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="mb-0 text-muted">Use different <code>color style</code> to color your element with a given table.</p>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-nowrap align-middle mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" colspan="2" class="text-center">Background <br> Gradient</th>
                                        <th scope="col" colspan="2" class="text-center">Background <br> Color</th>
                                        <th scope="col" colspan="2" class="text-center">Background <br> Soft</th>
                                        <th scope="col" colspan="2" class="text-center">Border <br> Colors</th>
                                        <th scope="col" colspan="2" class="text-center">Text <br> Colors</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    {{-- Primary. --}}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text-opacity-100 text-primary">text-opacity-100
                                            </div>
                                        </td>
                                    </tr>
                                    </tbody>
