                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6 mt-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="id-project_start_date" name="project_start_date" autocomplete="off"
                                        ...
                                        <div class="col-sm-12 col-md-6 mt-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="id-project_end_date" name="project_end_date" autocomplete="off"
