                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-4 mt-3">
                                                ...
                                                <select id="id-priority" name="priority" class="form-select @error('priority') is-invalid @enderror">
                                                    <option value="">-</option>
                                                    <option value="{{ \App\Enums\ProjectPriority::LOW }}">{{ __('Low') }}</option>
                                                    <option value="{{ \App\Enums\ProjectPriority::MEDIUM }}">{{ __('Medium') }}</option>
                                                    <option value="{{ \App\Enums\ProjectPriority::HIGH }}">{{ __('High') }}</option>
                                                </select>
                                                @error('priority')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-sm-12 col-md-4 mt-3">
                                                ...
                                                <select id="id-project-status" name="status" class="form-select @error('priority') is-invalid @enderror">
                                                    <option value="">-</option>
                                                    <option value="{{ \App\Enums\ProjectStatus::NOT_STARTED}}">{{ __('Not started') }}</option>
                                                    <option value="{{ \App\Enums\ProjectStatus::IN_PROGRESS }}">{{ __('In progress') }}</option>
                                                    <option value="{{ \App\Enums\ProjectStatus::COMPLETED }}">{{ __('Complete') }}</option>
                                                </select>
                                                @error('status')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
...
{{--                                    </div>--}}
                                ...
                                <div class="text-end ps-3 pe-3 mt-3">
                                    <button type="button" id="btn-save-project" class="btn btn-primary">{{ __('Save') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
