...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $employee6->job_position = 'PS_PG';
        $employee6->full_name = 'Tran Phuc Hong';
        $employee6->email = 'hongtp@test.com';
        $employee6->password = Hash::make('12345678');
        $employee6->role = UserRole::USER;
        $employee6->join_date = '2025-01-06';
        $employee6->employee_costs = 300000.00;
        $employee6->save();

        // ID: 7
        $employee7 = new User();
        $employee7->department_id = 1;
        $employee7->job_position = 'SE';
        $employee7->full_name = 'Nguyen Minh Vu';
        $employee7->email = 'vunm@test.com';
        $employee7->password = Hash::make('12345678');
        $employee7->role = UserRole::USER;
        $employee7->join_date = '2018-01-02';
        ...
        $employee8->full_name = 'Bui Thi Thom';
        $employee8->email = 'thombt@test.com';
        $employee8->password = Hash::make('12345678');
        $employee8->role = UserRole::USER;
        $employee8->join_date = '2015-07-01';
        ...
        $employee9->full_name = 'Nguyen Thuong Minh';
        $employee9->email = 'minhnt@test.com';
        $employee9->password = Hash::make('12345678');
        $employee9->role = UserRole::USER;
        $employee9->join_date = '2014-08-18';
        ...
        $employee10->job_position = 'PS_SE';
        $employee10->full_name = 'Nguyen Tien Trung';
        $employee10->email = 'trungnt11@test.com';
        $employee10->password = Hash::make('12345678');
        $employee10->role = UserRole::USER;
        $employee10->join_date = '2024-09-04';
        $employee10->employee_costs = 370000.00;
        $employee10->save();
        ...
        $employee11->full_name = 'Nguyen Anh Tuan';
        $employee11->email = 'tuanna@test.com';
        $employee11->password = Hash::make('12345678');
        $employee11->role = UserRole::USER;
        $employee11->join_date = '2024-09-04';
        $employee11->employee_costs = 310000.00;
        $employee11->save();

        // ID: 12
        $employee12 = new User();
        $employee12->department_id = 1;
        $employee12->job_position = 'SE';
        $employee12->full_name = 'Nguyen Thanh Trung';
        $employee12->email = 'trungnt13@test.com';
        $employee12->password = Hash::make('12345678');
        $employee12->role = UserRole::USER;
        $employee12->join_date = '2014-08-04';
        $employee12->employee_costs = 300000.00;
        $employee12->save();
        ...
        $employee13->full_name = 'Pham Long Quan';
        $employee13->email = 'quanpl@test.com';
        $employee13->password = Hash::make('12345678');
        $employee13->role = UserRole::USER;
        $employee13->join_date = '2018-06-11';
        ...
        $employee14->full_name = 'Do Tuan Thanh';
        $employee14->email = 'thanhdt@test.com';
        $employee14->password = Hash::make('12345678');
        $employee14->role = UserRole::USER;
        $employee14->join_date = '2020-12-07';
        ...
        $employee15->full_name = 'Bui Hong Khanh';
        $employee15->email = 'khanhbh@test.com';
        $employee15->password = Hash::make('12345678');
        $employee15->role = UserRole::USER;
        $employee15->join_date = '2007-11-07';
        ...
        $employee16->job_position = 'PG';
        $employee16->full_name = 'Nguyen Hai Anh';
        $employee16->email = 'anhnh@test.com';
        $employee16->password = Hash::make('12345678');
        $employee16->role = UserRole::USER;
        $employee16->join_date = '2023-12-01';
        $employee16->employee_costs = 250000.00;
        $employee16->save();
        ...
        $employee17->full_name = 'Hoang Quang Linh';
        $employee17->email = 'linhhq@test.com';
        $employee17->password = Hash::make('12345678');
        $employee17->role = UserRole::USER;
        $employee17->join_date = '2024-04-15';
        ...
        $employee18->full_name = 'Luu Thi Hai Yen';
        $employee18->email = 'yenlth@test.com';
        $employee18->password = Hash::make('12345678');
        $employee18->role = UserRole::USER;
        $employee18->join_date = '2024-08-12';
        ...
        $employee19->full_name = 'Nguyen Tuan Anh';
        $employee19->email = 'anhnt@test.com';
        $employee19->password = Hash::make('12345678');
        $employee19->role = UserRole::USER;
        $employee19->join_date = '2024-09-17';
        ...
        $employee20->job_position = 'PS_PG';
        $employee20->full_name = 'Pham Van Dat';
        $employee20->email = 'datpv@test.com';
        $employee20->password = Hash::make('12345678');
        $employee20->role = UserRole::USER;
        $employee20->join_date = '2024-09-04';
        $employee20->employee_costs = 220000.00;
        $employee20->save();

        // ID: 21
        $employee21 = new User();
        $employee21->department_id = 1;
        $employee21->job_position = 'PG';
        $employee21->full_name = 'Tran Anh Duc';
        $employee21->email = 'ducta@test.com';
        $employee21->password = Hash::make('12345678');
        $employee21->role = UserRole::USER;
        $employee21->join_date = '2024-11-04';
        $employee21->employee_costs = 250000.00;
        $employee21->save();
        ...
        $employee22->full_name = 'Nguyen Xuan Truong';
        $employee22->email = 'truongnx@test.com';
        ...
        $employee23->job_position = 'PS_PL';
        $employee23->full_name = 'Nguyen Minh Quang';
        $employee23->email = 'anhnm@test.com';
        $employee23->password = Hash::make('12345678');
        $employee23->role = UserRole::USER;
        $employee23->join_date = '2024-12-02';
        $employee23->employee_costs = 370000.00;
        $employee23->save();

        // ID: 24
        $employee24 = new User();
        $employee24->department_id = 1;
        $employee24->job_position = 'CM';
        $employee24->full_name = 'Nguyen Thi Ngoc Anh';
        $employee24->email = 'anhntn@test.com';
        $employee24->password = Hash::make('12345678');
        $employee24->role = UserRole::USER;
        $employee24->join_date = '2025-02-04';
        $employee24->employee_costs = 300000.00;
        $employee24->save();
        ...
        $employee25->full_name = 'Tran Minh Hang';
        $employee25->email = 'hangtm@test.com';
        $employee25->password = Hash::make('12345678');
        $employee25->role = UserRole::USER;
        $employee25->join_date = '2024-05-02';
        ...
        $employee26->job_position = 'CM';
        $employee26->full_name = 'Hoang Thi Ngoc Dung';
        $employee26->email = 'dunghtn@test.com';
        $employee26->password = Hash::make('12345678');
        $employee26->role = UserRole::USER;
        $employee26->join_date = '2024-11-04';
        ...
        // ID: 28
        $employee28 = new User();
        $employee28->department_id = 2;
        $employee28->full_name = 'Hoang Ha Diep';
        $employee28->email = 'diephh@bip.com.vn';
        $employee28->password = Hash::make('12345678');
        $employee28->role = UserRole::USER;
        $employee28->join_date = '2024-01-17';
        $employee28->save();

        // ID: 29
        $employee29 = new User();
        $employee29->department_id = 2;
        $employee29->full_name = 'Nguyen Thanh Hao';
        $employee29->email = 'haont@bip.com.vn';
        $employee29->password = Hash::make('12345678');
        $employee29->role = UserRole::USER;
        $employee29->join_date = '2009-07-23';
        $employee29->save();
        ...
        $manager4->employee_costs = 400000.00;
        $manager4->save();

        // ID: 31
        $employee31 = new User();
        $employee31->department_id = 1;
        $employee31->full_name = 'employee';
        $employee31->email = 'employee@test.com';
        $employee31->password = Hash::make('12345678');
        $employee31->role = UserRole::USER;
        $employee31->employee_costs = 250000.00;
        $employee31->save();
    }
}
